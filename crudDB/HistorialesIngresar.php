...
<html lang="en">
    ...
    <body>
        ...
        if(isset($_POST["Agregar"])){
            ...
            $respuesta=$conexion -> query("INSERT INTO historial values ('".$idhistorial."', '".$idpaciente."', '".$idtratamiento."');");
            header("location: Historiales.php");
        }else{
            ?>
            <div id='formulario'>
                <h1>Formulario Historiales</h1>
                <form action='HistorialesIngresar.php' method='POST'>
                    <div class='sub1'>
                        <div class='subsub1'>
                            <p>IdHistorial: </p>
                        </div>
                        <div class='subsub2'>
                            <input type='text' name='idhistorial' placeholder='Ingrese un codigo de historial' required>
                        </div>
                    </div>
                    <div class='sub1'>
                        <div class='subsub1'>
