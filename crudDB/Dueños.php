    ...
    <body>
        ...
        <table border='1'>
                <tr>
                    ...
                    <th style='width:120px; height:50px;'>Telefono</th>
                    <th style='width:200px; height:50px;'>Acciones</th>
                </tr>
                <?php
                require('Conexion.php');

                $pacientes = $conexion ->  query('SELECT * FROM dueño');
                while ($resultado = $pacientes -> fetch_assoc()){
                    ...
                    echo '<td><a class="btn-actualizar" href="DueñosActualizar.php?dni='.$resultado["dni"].'&idpaciente='.$resultado["idpaciente"].'">Actualizar</a><a class="btn-borrar" href="DueñosBorrar.php?dni='.$resultado["dni"].'&idpaciente='.$resultado["idpaciente"].'">Borrar</a></td>';
                    echo '</tr>';
                }
                ?>
            </table>
        ...
        <div id='pie'>
            ...
            <div id='subpie2'>
                <a class='btn-agregar' href='DueñosIngresar.php'>Agregar Dueños</a>
            </div>
        </div>
    </body>
</html>